 ...
 */
package my.bookstore.test.setup;
...
import my.bookstore.test.constants.BookstoreTestConstants;
import my.bookstore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = BookstoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/bookstoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/bookstoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/bookstoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/bookstoretest/import/csquotes.impex");
		}
	}
}
