...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/bookstorestorefront/electronics/en",
						"https://electronics.local:9002/bookstorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/bookstorestorefront/electronics/en",
						"https://electronics.local:9002/bookstorestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/bookstorestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/bookstorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/bookstorestorefront/electronics/en",
						"https://electronics.local:9002/bookstorestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/bookstorestorefront",
						"https://electronics.local:9002/bookstorestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/bookstorestorefront",
						"https://electronics.local:9002/bookstorestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/bookstorestorefront/electronics/en",
						"https://electronics.local:9002/bookstorestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
