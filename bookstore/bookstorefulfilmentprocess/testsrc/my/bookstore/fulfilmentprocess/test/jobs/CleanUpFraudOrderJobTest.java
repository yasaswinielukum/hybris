 ...
 */
package my.bookstore.fulfilmentprocess.test.jobs;
...
import my.bookstore.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = BookstoreFulfilmentProcessConstants.ORDER_PROCESS_NAME;
