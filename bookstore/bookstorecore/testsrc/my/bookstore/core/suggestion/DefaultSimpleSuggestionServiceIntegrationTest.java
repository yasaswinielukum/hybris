 ...
 */
package my.bookstore.core.suggestion;
...
import my.bookstore.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/bookstorecore/test/testSimpleSuggestionService.csv", "utf-8");
	}
